...
rule run_happy:
    ...
    params:
        ...
        strat_tsv=lambda wildcards: f"results/evaluations/happy/{wildcards.eval_id}_{wildcards.bench_id}/{wildcards.ref_id}/{config['references'][wildcards.ref_id]['stratifications']['tsv']}",
