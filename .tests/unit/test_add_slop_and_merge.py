...
def test_add_slop_and_merge():

    with TemporaryDirectory() as tmpdir:
        workdir = Path(tmpdir) / "workdir"
        data_path = PurePosixPath(".tests/unit/add_slop_and_merge/data")
        expected_path = PurePosixPath(".tests/unit/add_slop_and_merge/expected")
