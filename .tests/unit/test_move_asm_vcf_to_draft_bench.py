...
def test_move_asm_vcf_to_draft_bench():
    ...
    with TemporaryDirectory() as tmpdir:
        ...
        expected_path = PurePosixPath(".tests/unit/move_asm_vcf_to_draft_bench/expected")
        ...
        # dbg
        print("results/draft_benchmarksets/testA/intermediates/GRCh38_chr21_asm17aChr21_dipcall-default.vcf.gz", file=sys.stderr)
