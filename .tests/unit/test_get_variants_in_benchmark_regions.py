...
def test_get_variants_in_benchmark_regions():
    ...
    with TemporaryDirectory() as tmpdir:
        ...
        expected_path = PurePosixPath(".tests/unit/get_variants_in_benchmark_regions/expected")

        # Copy data to the temporary workdir.
        shutil.copytree(data_path, workdir)

        # dbg
        print("results/draft_benchmarksets/testA/GRCh38_chr21_asm17aChr21_smvar_dipcall-default_bench-vars.vcf.gz", file=sys.stderr)
