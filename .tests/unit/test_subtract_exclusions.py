...
def test_subtract_exclusions():
    ...
    with TemporaryDirectory() as tmpdir:
        ...
        # dbg
        print("results/draft_benchmarksets/testB/GRCh38_chr21_asm17aChr21_dipcall-default.excluded.bed results/draft_benchmarksets/testB/GRCh38_chr21_asm17aChr21_dipcall-default.excluded_stats.txt", file=sys.stderr)
